...
class WorkScheduleService
{
    ...
    public function getUserActiveScheduleForDate(User $user, $date = null): ?WorkSchedule
    {
        ...
        $assignment = UserWorkScheduleAssignment::where('user_id', $user->id)
            ->where('effective_start_date', '<=', $targetDate)
     ...
     */
    public function assignScheduleToUser(
        User $user,
        ...
        UserWorkScheduleAssignment::where('user_id', $user->id)
        ...
        return UserWorkScheduleAssignment::create([
            'user_id' => $user->id,
            'work_schedule_id' => $workSchedule->id,
            'effective_start_date' => $parsedStartDate->toDateString(),
            'effective_end_date' => $effectiveEndDate ? Carbon::parse($effectiveEndDate)->toDateString() : null,
